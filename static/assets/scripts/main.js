...
if (nav) {
  var html = `
    ...
    <div class="fixed-nav-bar-right">
      <a class="navbar-link" href="/./g"><i class="fa-solid fa-none navbar-icon"></i><xn>Ga</xn><xn>mes</xn></a>
      <a class="navbar-link" href="/./ap"><i class="fa-solid fa-none2 navbar-icon"></i><xn>Ap</xn><xn>ps</xn></a>
      <a class="navbar-link" href="/./t"><i class="fa-solid fa-none3 navbar-icon"></i><xn>Ta</xn><xn>bs</xn></a>
      <a class="navbar-link" href="/./s"><i class="fa-solid fa-none4 navbar-icon"></i><xn>Set</xn><xn>tings</xn></a>
    </div>`
  nav.innerHTML = html
}
